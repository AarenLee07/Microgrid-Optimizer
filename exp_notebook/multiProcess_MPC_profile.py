...
exp_suffix = "thesis_daily_profile"
...
log_fn = os.path.join(exp_folder, "6h-bat-Oct-GT&Heuristic.xlsx")#_oneday_12months

save_path = os.path.join(log_folder,exp_suffix, "6h-bat-Oct-GT&Heuristic")
    ...
    for i in range(1):
        try:
            ...
            var_keys = [
                        ...
                        "p_grid_max_method",]
            em.run(keys=var_keys, num_trials=2, fork_id=fork_id)
