...
save_path = os.path.join(log_folder,exp_suffix, "pred_bld_pv_ev_no_revised")
    ...
    for i in range(10):
        try:
            ...
            var_keys = [  
                        ...
                        "simple_bld_num", "simple_bld_exp_alpha",
                        "ev_charge_rule_default",
                        #"pv_to_bld","ev_to_bld",
                        "p_grid_max_method",]
...
if __name__ == '__main__':     
    ...
    log_fn = os.path.join(exp_folder, "pred_bld_pv_ev_no_revised_ori_simple.xlsx")#_oneday_12months
    for i in range(8):
